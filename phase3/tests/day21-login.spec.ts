// Day 21 — First Playwright Test (TypeScript)
// Automates the Day 1 login test cases
// Target: https://the-internet.herokuapp.com/login
// Run: npx playwright test tests/day21-login.spec.ts

import { test, expect } from '@playwright/test';

// ============================================================
// CONSTANTS
// (In a real project these move to a shared fixtures/constants.ts)
// ============================================================
const LOGIN_URL = '/login';    // Relative to baseURL in playwright.config.ts
